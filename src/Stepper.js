...
function Stepper({
  ...
  completeBorderStyle, activeBorderStyle, defaultBarColor, completeBarColor, lineMarginOffset, defaultBorderWidth, lineHeight, rightBarOffset, leftBarOffset, hasLabel
}) {
  return (
