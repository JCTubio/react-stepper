  ...
  _createClass(Step, [{
    ...
    value: function getStyles() {
      var _props = this.props,
          ...
          leftBarOffset = _props.leftBarOffset,
          rightBarOffset = _props.rightBarOffset;
    ...
    value: function render() {
      ...
      var renderLabel = function renderLabel() {
        if (hasLabel) {
          return active || completed ? _react2.default.createElement(
            'a',
...
Step.propTypes = {
  ...
  lineHeight: _propTypes.PropTypes.number,
  leftBarOffset: _propTypes.PropTypes.string,
  rightBarOffset: _propTypes.PropTypes.string,
  hasLabel: _propTypes.PropTypes.bool
};