...
function Stepper(_ref) {
  var activeStep = _ref.activeStep,
      ...
      rightBarOffset = _ref.rightBarOffset,
      leftBarOffset = _ref.leftBarOffset,
    ...
    _react2.default.createElement(
      ...
      steps.map(function (step, index) {
        return _react2.default.createElement(_Step2.default, {
          ...
          leftBarOffset: leftBarOffset,
          rightBarOffset: rightBarOffset,
          hasLabel: hasLabel
        });
      })
    )
...
Stepper.propTypes = {
  ...
  lineHeight: _propTypes.PropTypes.string,
